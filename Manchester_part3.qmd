...
```{r 5.8.1}
#| output: asis
#| fig-alt: "A plot of the proportion of 17-34 by regions"
...
![](pics/lfs_vol1_SE.png){fig-alt="Screenshot of the LFS Volume 1 Documentation showing standard errors and design factors"}
